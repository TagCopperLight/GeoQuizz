...
class InterCollection(Interface):
    ...
    def sub_update(self, events, mouse_pos, collection):
        self.events = events
        ...
        #     self.order_clicked = random.choice(self.collections)
        #     clicked = True
        # for index, action in enumerate(self.actions):
        #     if action:
        #         self.order_clicked = self.collections[index]
        #         clicked = True
